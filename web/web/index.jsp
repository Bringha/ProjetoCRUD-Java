...
<div class="container px-4 py-4" id="custom-cards">
    ...
    <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
        ...
        <jsp:useBean class="br.com.alfashop.repository.ProdutoDAO" id="listaProdutos" />
        <c:forEach items="${listaProdutos.destaques}" var="objProduto">

            <div class="col">
                <div class="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg" style="background-image: url('https://picsum.photos/400/200?random=${objProduto.idProduto}');">
